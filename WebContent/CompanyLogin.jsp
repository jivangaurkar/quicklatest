		...
		<form:form method="post" modelAttribute="company" >
			<center>
				...
				<table width="30%" cellpadding="5">
					<tr>
						<td>E-Mail :</td>
						<td><form:input type="email" name="email" value=""
								path="email"  maxlength="25" required="true" /></td>
					</tr>
					<tr>
						<td>Password :</td>
						<td><form:input type="password" name="password" value=""
								path="password"  maxlength="15" required="true"/></td>
					</tr>
					<tr>
						<td></td>
					...
					<tr>
						<td colspan="2">not registered!! <a href="CompanySignup">Sign
								Up Here</a></td>
					</tr>
				</table>
			</center>
